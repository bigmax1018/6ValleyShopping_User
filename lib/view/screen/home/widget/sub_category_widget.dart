...
class SubCategoryWidget extends StatelessWidget {
  ...
  final int index;
  final int length;
  const SubCategoryWidget({Key? key, required this.sub_category, required this.index, required this.length}) : super(key: key);
    ...
    return Padding(padding: EdgeInsets.only(left : Provider.of<LocalizationProvider>(context, listen: false).isLtr ? Dimensions.homePagePadding : 0,
      ...
      child: Column( children: [
        ...
        Center(child: SizedBox(width: 70,
            child: Text(sub_category.name!, textAlign: TextAlign.center, maxLines: 2,
